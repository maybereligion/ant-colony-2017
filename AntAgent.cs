...
namespace SOFT152Steering
{
    class AntAgent
    {
        ...
        //does ant currently have food
        public bool hasFood { set; get; }

        //is the ant close to another ant 
        public bool closeToAnt { set; get; }

        //is the ant close to nest 
        public bool closeToNest { set; get; }

        //ants knowledge of food location 
        public SOFT152Vector nestLocation { set; get; }

        //is the ant close to a food object
        public bool closeToFood { set; get; }
